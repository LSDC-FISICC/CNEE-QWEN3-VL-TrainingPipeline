...
MAX_IMAGENES = 2
OUTPUT_DIR   = f"/home/{user}/data/output/qwen3vl_4b_v2_{date}"
MODEL_PATH   = f"/home/{user}/code/CNEE-QWEN3-VL-TrainingPipeline/models/Qwen3-VL-4B-Instruct"
DATASET_PATH = f"/home/{user}/data/dataset/dataset_FINAL_rev_100casos_v4b.json"
BASE         = f"/home/{user}/data"
NUM_EPOCHS   = 5 # <-- Cambiar aqui
